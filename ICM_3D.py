...
class ICM_3D:
  ...
  @property
  def x(self):
    return self.scaler * read_signed_16(self.bus, self.dev, self.x_h_reg, self.x_l_reg)
  
  @property
  def y(self):
    return self.scaler * read_signed_16(self.bus, self.dev, self.y_h_reg, self.y_l_reg)
